...
<template>
    ...
    <div class="flex min-h-screen bg-white dark:bg-gray-950">
        ...
        <aside :class="`fixed top-0 left-0 z-40 w-64 h-screen transition-transform bg-gray-300 dark:bg-indigo-950 ${showingSidebar ? 'translate-x-0' : '-translate-x-full sm:translate-x-0'}`" aria-label="Sidebar">
            <div class="h-full py-4 px-3 overflow-y-auto flex flex-col">
                <div class="">
                    <h2 class="text-lg font-serif dark:text-gray-200 mb-4">SSVRS</h2>
